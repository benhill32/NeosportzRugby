...
function createDB(tx) {
    ...
    db.transaction(function(tx) {
        tx.executeSql('CREATE TABLE IF NOT EXISTS MobileApp_Schedule_Menu (_id INTEGER NOT NULL UNIQUE, DivisionName TEXT NOT NULL,DivisionID INTEGER NOT NULL,UpdateDateUTC TEXT NULL,DatetimeStart TEXT NOT NULL,DivisionOrderID INTEGER NOT NULL)');
    ...
    tx.executeSql('CREATE TABLE IF NOT EXISTS MobilevwApp_News_v_2 (ID INTEGER NOT NULL UNIQUE,_id INTEGER NOT NULL,UpdateDateUTC TEXT NULL,Title TEXT NOT NULL,Body TEXT NULL,ClubID INTEGER NOT NULL,TeamID TEXT NULL,Hide TEXT NULL,IsAd TEXT NULL,Base64 TEXT NULL,URL TEXT NULL,Hint TEXT NULL,DisplayDateUTC TEXT NOT NULL,DisplaySecondsUTC TEXT NOT NULL,DeletedateUTC TEXT NOT NULL,FromPhone Text NOT NULL)');
    console.log("MobilevwApp_News_v_2 table is created");

    tx.executeSql('CREATE TABLE IF NOT EXISTS MobileScoringTable (ID INTEGER NOT NULL UNIQUE,Name TEXT NOT NULL, Value INTEGER NOT NULL,UpdatedateUTC TEXT NOT NULL,DeletedateUTC TEXT NOT NULL)');
    console.log("MobileScoringTable table is created");

    tx.executeSql('CREATE TABLE IF NOT EXISTS MobileStandings (_id INTEGER NOT NULL UNIQUE,Games INTEGER NOT NULL,Won INTEGER NOT NULL,Drawn INTEGER NOT NULL,Lost INTEGER NOT NULL,ForScore INTEGER NOT NULL,AgainstScore INTEGER NOT NULL,Difference INTEGER NOT NULL,ClubID INTEGER NOT NULL,Name TEXT NULL,TournamentID INTEGER NOT NULL,FlagPoints INTEGER NOT NULL,UpdateDateUTC TEXT NULL,TournamentName TEXT NULL,DeletedateUTC TEXT NOT NULL)');
    console.log("MobileStandings table is created");

    tx.executeSql('CREATE TABLE IF NOT EXISTS Mobilesponsorsclub (ID INTEGER NOT NULL UNIQUE,Datetime TEXT NULL,Club INTEGER NOT NULL,Name TEXT NOT NULL,Website TEXT NULL,Image TEXT NULL,UserID TEXT NULL,OrderBy INTEGER NULL,Base64 TEXT NULL,CreatedateUTC TEXT NULL,UpdatedateUTC TEXT NULL,DeletedateUTC TEXT NULL,UpdatedateUTCBase64 TEXT NULL)');
    console.log("Mobilesponsorsclub table is created");


    tx.executeSql('CREATE TABLE IF NOT EXISTS Mobilescreenimage (_id INTEGER NOT NULL UNIQUE,Base64 TEXT NULL,BackgroundColor TEXT NULL,SoftwareFade TEXT NULL,UpdateDateUTC TEXT NULL,TopText TEXT NULL,BottomText TEXT NULL)');
    console.log("Mobilescreenimage table is created");

    tx.executeSql('CREATE TABLE IF NOT EXISTS Mobilescoringbreakdown (ID INTEGER NOT NULL UNIQUE,CreatedateUTC TEXT NULL,UpdatedateUTC TEXT NULL,DeletedateUTC TEXT NULL,TeamID INTEGER NOT NULL,GameID INTEGER NOT NULL,PlayerID INTEGER NOT NULL,ScoringID INTEGER NOT NULL,Time TEXT NULL)');
